  ...
  module ControllerRuntime
    ...
    protected
      ...
      def process_action(action, *args)
        Spyke::LogSubscriber.reset_runtime
        super
      end

      def cleanup_view_runtime
        spyke_runtime_before_render = Spyke::LogSubscriber.reset_runtime
        self.spyke_runtime = (spyke_runtime || 0) + spyke_runtime_before_render
        runtime = super
        spyke_runtime_after_render = Spyke::LogSubscriber.reset_runtime
      ...
      def append_info_to_payload(payload)
        super
        payload[:spyke_runtime] = (spyke_runtime || 0) + Spyke::LogSubscriber.reset_runtime
      end
...
ActiveSupport.on_load(:action_controller) do
  include Spyke::ControllerRuntime
end
